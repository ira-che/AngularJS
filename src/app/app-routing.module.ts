...
const routes: UiState[] = [
  { name: 'index', url: '', redirectTo: 'main-page' },
  { name: 'main-page', url: '/main-page', component: DashboardComponent },
  { name: 'detail', url: '/detail/{id}', component: HeroDetailComponent },
  { name: 'list-of-users', url: '/list-of-users', component: HeroesComponent }
];
